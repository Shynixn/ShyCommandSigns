...
fun registerPluginJar(
    ...
    tasks.register(relocateTaskName, com.github.jengelman.gradle.plugins.shadow.tasks.ShadowJar::class.java) {
        ...
        relocate("com.github.shynixn.mcutils", "com.github.shynixn.shycommandsigns.lib.com.github.shynixn.mcutils")
        if (isLegacy) {
            relocate(
                "com.github.shynixn.mccoroutine",
                "com.github.shynixn.shycommandsigns.lib.com.github.shynixn.mccoroutine"
            )
            relocate(
                "com.github.shynixn.fasterxml",
                "com.github.shynixn.shycommandsigns.lib.com.github.shynixn.fasterxml"
            )
            relocate("kotlin", "com.github.shynixn.shycommandsigns.lib.kotlin")
            relocate("kotlinx", "com.github.shynixn.shycommandsigns.lib.kotlinx")
            relocate("org.intellij", "com.github.shynixn.shycommandsigns.lib.org.intellij")
            relocate("org.jetbrains", "com.github.shynixn.shycommandsigns.lib.org.jetbrains")
            relocate("javax", "com.github.shynixn.shycommandsigns.lib.javax")
        }
    }
    ...
    tasks.register(jarTaskName, com.github.jengelman.gradle.plugins.shadow.tasks.ShadowJar::class.java) {
        ...
        if (!isFolia) {
            exclude("com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/common/FoliaMarker.class")
        }
        ...
        if (excludeOldNms) {
            val oldNmsPaths = listOf(
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_8_R3/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_9_R2/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_17_R1/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_18_R1/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_18_R2/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_19_R1/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_19_R2/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_19_R3/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_20_R1/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_20_R2/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_20_R3/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_20_R4/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R1/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R2/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R3/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R4/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R5/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R6/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R7/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v26_1_R1/**",
                "com/github/shynixn/shycommandsigns/lib/com/github/shynixn/mcutils/packet/nms/v26_1_R2/**"
            )
...
tasks.register("languageFile") {
    ...
    val contractFile = kotlinSrcFolder.resolve("com/github/shynixn/shycommandsigns/contract/ShyCommandSignsLanguage.kt")
    ...
    contractContents.add("package com.github.shynixn.shycommandsigns.contract")
    ...
    contractContents.add("")
    contractContents.add("interface ShyCommandSignsLanguage : LanguageProvider {")
    for (key in lines) {
    ...
    val implFile = kotlinSrcFolder.resolve("com/github/shynixn/shycommandsigns/ShyCommandSignsLanguageImpl.kt")
    val implContents = ArrayList<String>()
    implContents.add("package com.github.shynixn.shycommandsigns")
    implContents.add("")
    implContents.add("import com.github.shynixn.mcutils.common.language.LanguageItem")
    implContents.add("import com.github.shynixn.shycommandsigns.contract.ShyCommandSignsLanguage")
    implContents.add("")
    implContents.add("class ShyCommandSignsLanguageImpl : ShyCommandSignsLanguage {")
    implContents.add(
